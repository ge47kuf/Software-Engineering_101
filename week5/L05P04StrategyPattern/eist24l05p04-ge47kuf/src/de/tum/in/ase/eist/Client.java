...
public final class Client {
	// TODO 1.1: Create a new class de.tum.in.ase.eist.LinearSearch and implement the performSearch
	// method according to the problem statement on Artemis
	// TODO 1.2: Create a new class de.tum.in.ase.eist.BinarySearch and implement the performSearch
	// method according to the problem statement on Artemis
	// TODO 2.1: Create a de.tum.in.ase.eist.SearchStrategy interface according to the UML class
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < NUMBER_OF_SIMULATIONS; i++) {
			...
			int pageNumber = -1;
			pageNumber = c.search(chapterToSearch);
