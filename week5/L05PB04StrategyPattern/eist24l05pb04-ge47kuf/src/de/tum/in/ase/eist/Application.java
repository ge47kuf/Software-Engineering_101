...
public class Application {
    public static void main(String[] args) {
        ...
        // If your implementation is correct, there will be no error

        /*
        // In the first test case, the distance is 5.6 km and the delivery is delivered by bike.
        Delivery delivery1 = new Delivery(5.6, new CalculateBike());
        System.out.println(delivery1.calculatePrice());

        // In the second test case, the distance is 11.73 km and the delivery is delivered by car.
