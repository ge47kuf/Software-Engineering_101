...
public class Client {
    ...
    public String performLogin(User user) {
        ...
        ResponseEntity<String> responseEntity = restTemplate.postForEntity(loginMicroserviceURL + "/performLogin",
    ...
    // solution: change the url in responseEntity to url (look up)
    public String sendTweet(Tweet tweet) {
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<Tweet> requestEntity = new HttpEntity<>(tweet, headers);
        ResponseEntity<String> responseEntity = restTemplate.postForEntity(tweetMicroserviceURL + "/send",
                requestEntity, String.class);
    ...
    public String deleteTweet(Tweet tweet) {
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<Tweet> requestEntity = new HttpEntity<>(tweet, headers);
        ResponseEntity<String> responseEntity = restTemplate.exchange(tweetMicroserviceURL + "/delete",
    ...
    public String follow(User user) {
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<User> requestEntity = new HttpEntity<>(user, headers);
        ResponseEntity<String> responseEntity = restTemplate.postForEntity(followMicroserviceURL + "/follow",
                requestEntity, String.class);
    ...
    public String unfollow(User user) {
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<User> requestEntity = new HttpEntity<>(user, headers);
        ResponseEntity<String> responseEntity = restTemplate.exchange(followMicroserviceURL + "/unfollow",
                HttpMethod.DELETE, requestEntity, String.class);
