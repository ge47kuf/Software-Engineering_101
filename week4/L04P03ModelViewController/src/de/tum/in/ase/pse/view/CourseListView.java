...
public class CourseListView extends Stage implements Observer {
	...
	//  Make sure that all parameters are set correctly and the view observes all courses
	...
	//  Make sure to check for duplicates and that the list view observes the added course
	...
	//  This method should send the controller the information to open up a new detail view
	private void selectCourse(Course course) {
		controller.selectCourse(course);
	}

	// TODO: Implement createCourse().
	//  This method should inform the controller about the creation process of a new course
