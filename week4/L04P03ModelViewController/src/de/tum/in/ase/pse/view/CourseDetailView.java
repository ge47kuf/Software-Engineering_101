...
public class CourseDetailView extends Stage implements Observer {
	...
	// TODO: Implement save().
	//  This method should update the course with the information entered by the user and save it using
	//  the controller
	...
	//  This method should update the view's text fields and title with the current values of the course
