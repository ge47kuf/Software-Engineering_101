...
public class CustomerController {
    ...
    public void addPerson(Customer customer, Consumer<List<Customer>> customerConsumer) {
        ...
        webClient.post()                    // initiates an HTTP POST request
                .uri("customers")       // set URI to specific endpoint
                .bodyValue(customer)        // sets the body of request to provided object
                .retrieve()                 // call up HTTP response
                .bodyToMono(Customer.class) // converts response body to instance of specified class
                .onErrorStop()              // ensures execution stops if error occurs during request/response process
                .subscribe(newCustomer -> { // subscribe to the Mono and provide a Consumer to handle the new customer
    ...
    public void updatePerson(Customer customer, Consumer<List<Customer>> customerConsumer) {
        ...
        webClient.put()
                ...
                .onErrorStop()
                .subscribe(newCustomer -> { // a list of old to update
